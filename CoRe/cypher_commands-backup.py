...
command_set = {}
command_set['events'] = "MATCH(n:TopLevelPathway {displayName:'#',speciesName:'Homo sapiens'})-[:hasEvent*]->(rle:ReactionLikeEvent) RETURN rle"
...
command_set['regulator'] = "MATCH(n:# {stId:'%'})-[:regulator]->(pe:PhysicalEntity) RETURN pe"
